    ...
    return (
        ...
        <div className={style.main}>
            {userDB !== 'loading' &&
                ...
                {success == 'TienesProfe' && <Error>Tu profe pre-configuro tu play</Error>}
                {success == false && success !== 'TienesProfe' && userDB.profesor == false && <Error>Hazte Premium para modificar datos</Error>}
