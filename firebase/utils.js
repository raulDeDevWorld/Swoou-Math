      ...
      function transactionDataCompare () {
            ...
            requestObjectStore.onsuccess = () => {
                  ...
                  if (IDB == undefined) {
                        ...
                        if (new Date(firebaseDB.date) > new Date(dateIDB) && new Date(firebaseDB.date) !== new Date(dateIDB)){
                              firebaseDB.date == null ? db.ref(`${firebaseDB.profesor ?  'teachers' : 'users'}/${auth.currentUser.uid}`).update({ date: Date(), ...firebaseDB}) : ''
                        ...
                        if (dateIDB > firebaseDB.date) {
                              ...
                              db.ref(`${firebaseDB.profesor ?  'teachers' : 'users'}/${auth.currentUser.uid}`).update({ date: Date(), ...firebaseDB, ...requestObjectStore.result })
                              return
